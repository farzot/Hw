...
class animal:
    def __init__(self) -> None:
        pass
    def eat(self):
        print("Eat nomli method yaratildi! ")
    def is_uy_hayvoni(self):
        print("Uy hayvoniga tekshiruvchi method yaratildi! ")
...
class yirtqichlar(animal):
    ...
    def eat(self,name):
            print(f"{name} go'shtxo'r hayvon!  ")
    ...
    def examples_for_meals(self,name,is_live_home):
            if is_live_home==False:
                print(f"{name} go'shtxo'r hayvon bo'lganligi sababli odatda o'txo'r hayvonlarni ov qilib yeydi! ")
            else:
...
class otxorlar(animal):
    ...
    def examples_for_meals(self,name):
            print(f"{name} o'txo'r hayvon bo'lganligi sababli o't va shunga o'xshash ovqatlar bilan oziqlanadi! ")
